...
then
    ...
    fabric-ca-client register --id.name $ENROLL_ID --id.secret $ENROLL_PW -u https://github-fabric-ca.railway.internal:7054 --id.type $ID_TYPE --tls.client.certfile /app/data/fabric-ca/ca-admin/tls/signcerts/cert.pem --tls.client.keyfile $KEYFILE
    sleep 5
