...
then
    ...
    KEYFILE=$(find /app/data/fabric-ca/ca-admin/msp/keystore -type f -name '*_sk')
    fabric-ca-client register --id.name $ENROLL_ID --id.secret $ENROLL_PW -u https://github-fabric-ca.railway.internal:7054 --id.type $ID_TYPE --tls.client.certfile /app/data/fabric-ca/ca-admin/msp/signcerts/cert.pem --tls.client.keyfile /app/data/fabric-ca/ca-admin/msp/keystore/$KEYFILE
    sleep 5
